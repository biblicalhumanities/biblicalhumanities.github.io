---
layout: post
title:  "Querying Greek Syntax Trees: Part 3"
...
- [Querying Greek Syntax Trees: Part 1]({% post_url 2015-11-13-querying-000 %}):  introduces simple queries on base texts.  
- [Querying Greek Syntax Trees: Part 2]({% post_url 2015-11-15-querying-001 %}):  discusses morphologies and three kinds of syntax trees
...
Before we do our first query on morphology, let's take a look at the word frequency query we used at the end of [Querying Greek Syntax Trees: Part 1]({% post_url 2015-11-13-querying-000 %}):
